    ...
    <section className="container mx-auto px-6 py-20">
      <div className="text-center max-w-4xl mx-auto mb-16 animate-fade-in">
        ...
        <p className="text-xl text-muted-foreground">
          Tools designed specifically for modern farmers and agricultural communities
        </p>
      </div>

      <div className="flex flex-col lg:flex-row gap-12 items-center">
        {/* Phone Image */}
        <div className="flex justify-center lg:justify-end animate-slide-in-left lg:w-1/3">
        ...
        <div className="lg:w-2/3 animate-slide-in-right">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-h-96 overflow-y-auto pr-4 custom-scrollbar">
